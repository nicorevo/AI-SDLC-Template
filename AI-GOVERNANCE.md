...
2. **Source of Truth**: ogni spec deve essere approvata esplicitamente prima di ogni azione successiva
3. **Tracciabilità**: tutto il codice AI-generated deve essere marcato
4. **Data classification**: non inviare dati CONFIDENTIAL/RESTRICTED ai modelli AI
5. **Audit trail**: ogni sessione AI significativa va documentata
